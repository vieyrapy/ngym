...
# Importante: Cero sangría para que el parser de Markdown no lo tome como código
st.markdown("""
...
# Hemos asegurado que NO haya sangría dentro del HTML inyectado para evitar que 
# Streamlit lo formatee como bloque de código (evita la caja negra con botón de copiar).
faqs = [
    ("¿Cuáles son las formas de pago?", "Presencial: Aceptamos tarjetas de crédito/débito directamente en la recepción del gimnasio en Montilla.<br>Online: Aceptamos pagos a través de nuestros enlaces oficiales y plataforma web.<br>Nota: Para las ofertas trimestrales, se debe abonar el total al iniciar para congelar el precio promocional."),
    ("¿Hay que pagar matrícula de inscripción?", "¡Oferta Actual!: Estamos de oferta y actualmente TODA la matrícula es 100% GRATIS."),
    ("¿Tienen permanencia o contrato obligatorio?", "Planes Mensuales: No tienen permanencia. Puedes darte de baja avisando antes del día 25 del mes.<br>Planes Trimestrales: No son reembolsables, ya que el descuento especial se otorga por el compromiso de tiempo adquirido."),
    ("¿Tienen duchas y taquillas?", "Duchas: Sí, contamos con vestuarios completos y duchas con agua caliente.<br>Taquillas (Lockers): Sí. Es obligatorio traer tu propio candado por seguridad para utilizarlas."),
    ...
    ("¿Cuáles son los horarios del gimnasio?", "Lunes a Viernes: 06:30 AM a 10:00 PM.<br>Sábados y Domingos: Cerrado."),
    ...
    ("¿Puedo cambiar de plan después de iniciar?", "Mensual: Sí, puedes cambiar de plan avisando con al menos 5 días de anticipación.<br>Trimestral: No, los planes trimestrales se mantienen con el mismo beneficio durante los 3 meses, sin cambios."),
    ...
    ("¿El gimnasio proporciona toallas o equipo personal?", "Toallas: No proporcionamos toallas (traer la propia es obligatorio por higiene).<br>Equipo: Todo el equipo de entrenamiento (pesas, bandas, colchonetas, etc.) está disponible para los socios."),
    ...
    ("¿Cómo puedo cancelar mi membresía?", "Opción A: Desde nuestra App cuando quieras.<br>Opción B: En Recepción avisando al menos 5 días antes del cierre del ciclo de pago.<br>Nota: Membresías trimestrales no son reembolsables.")
]

faq_items_html = "".join([f"""<details class="border-b border-slate-200 py-2">
...
<div class="pb-6 text-slate-600 leading-relaxed font-medium">{a}</div>
