...
# 8. CLASES EXCLUSIVAS
st.markdown("<div class='section-title'>Clases Grupales <span class='gradient-text'>Incluidas</span></div><p style='text-align: center; margin-bottom: 1rem; color: #94a3b8; font-weight: 600; font-size: 1rem;'>Únete a las clases grupales exclusivos para socios activos.</p>", unsafe_allow_html=True)
