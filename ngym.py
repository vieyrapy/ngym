...
# 8. CLASES EXCLUSIVAS
st.markdown("<div class='section-title'>Clases Grupales <span class='gradient-text'>Incluidas</span></div><span>Únete a las clases grupales exclusivos para socios activos.</span>", unsafe_allow_html=True)
